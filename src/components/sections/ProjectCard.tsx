...
export function ProjectCard({ project }: ProjectCardProps) {
  return (
    <Link href={`/etkinliklerimiz/${project.slug}`} className="group relative block overflow-hidden rounded-2xl bg-muted aspect-[2/1] shadow-lg hover:shadow-2xl transition-all duration-500">
      {project.coverImage ? (
        <>
          <Image
